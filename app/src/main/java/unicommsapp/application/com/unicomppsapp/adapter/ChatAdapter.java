...
public class ChatAdapter extends ArrayAdapter<ChatMessage> {
    ...
    /**
     * Handle users. Fill the onlineNow set with current users.
     * Data is used to display a green dot next to users who are currently
     * online.
    ...
    /**
     * Overwrite the onlineNow array with all the values
     * attained from a call to hereNow().
     * @param onlineNow
     */
    ...
    /**
     * Format the long System.currentTimeMillis() to a better looking
     * timestamp. Uses a calendar object to format with the user's current
     * time zone.
     * @param timeStamp
     * @return
     */
    public static String formatTimeStamp(long timeStamp){
        ...
        // for displaying date in specified format.
    ...
    /**
     * Clear all values from the values array and update the listview.
