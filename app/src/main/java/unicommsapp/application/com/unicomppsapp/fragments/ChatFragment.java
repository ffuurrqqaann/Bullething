...
import unicommsapp.application.com.unicomppsapp.*;
import unicommsapp.application.com.unicomppsapp.adapter.ChatAdapter;

/**
 * This like rest off the chat part is courtesy of open source
 * PubNub example chat application by Kevin Gleason. Integration, convertion
 * into fragment and other necessary tweaks by Oula Kuuva.
 * Android PubNub Lolli-Chat in github:
...
public class ChatFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMessageET = (EditText) rootView.findViewById(R.id.message_et);
        mSendButton = (Button) rootView.findViewById(R.id.send_message);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mSharedPrefs = getActivity().getSharedPreferences(
                Constants.CHAT_PREFS, Context.MODE_PRIVATE
        );
        ...
        this.mChatAdapter = new ChatAdapter(
                getContext(), new ArrayList<ChatMessage>()
        );
        // Set user to online. Status changes handled in presence
    ...
    */
    ...
    public void publish(String type, JSONObject data){
        ...
        this.mPubNub.publish(this.channel, json, new ChatCallback());
    }
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            if (!online)
                                ...
                                Toast.makeText(
                                        getContext(),
                                        user + " logged in since " +
                                                ChatAdapter.formatTimeStamp(loginTime),
                                        Toast.LENGTH_SHORT
                                ).show();
                        }
                    });
    ...
    private void setupListView(){
        this.mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // Currently disabled, like all things requiring GCM
    ...
    private void alertHereNow(Set<String> userSet){
        ...
        final ArrayAdapter<String> hnAdapter = new ArrayAdapter<>(
                getContext(),
